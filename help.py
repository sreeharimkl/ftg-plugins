...
class HelpMod(loader.Module):
    ...
    async def helpcmd(self, message):
        ...
        if not args:
        	...
        	"\n\n\n<code>.help raph</code><b>:</b><i> <b> Shows all your PP and PPE originated modules. </b> </i> \n"
        	"\n<code>.help uni</code><b>:</b><i> <b> Shows all your Uniborg originated modules. </b> </i> \n"
        	"\n<code>.help ftg</code><b>:</b><i> <b> Shows all your native modules. </b> </i> \n"
        	"\n<code>.help all</code><b>:</b><i> <b> Shows all your modules. </b> </i> \n")
        	return
